...
This first implementation prioritises a small, inspectable domain model.
Persistence and cryptographic event storage will be added after the core
behaviour has tests.
"""
    ...
    def assess_claim(
        ...
        *,
        ...
        self._record(
            "claim.assessed",
            claim_id,
            {"status": status, "evidence_level": evidence_level, "summary": summary},
        )
        return claim
